...
const Whoweare: React.FC = () => {
    return (
        <section className="w-full bg-white pb-32 px-4 sm:px-10 lg:px-20">
            <div
                className="grid mx-auto w-[998px] grid-cols-[22px_219px_46px_22px_29px_151px_107px_29px_26px_84px_203px_16px_14px_30px] grid-rows-[4px_159px_4px_134px_44px_24px_15px_115px_90px_193px_119px_159px_72px]"
            >
                {/* ROW 1: Top section */}
                ...
                {/* ROW 3 */}
                {/* <div className="col-start-1 col-end-4 row-start-8">
