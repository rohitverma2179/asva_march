            ...
            <div className="max-w-306 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col p-6 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                        <span className="font-['Kalnia'] font-bold text-[24px] text-[#000000] mb-4">1.</span>
                    ...
                    {/* Column 2 */}
                    <div className="flex flex-col p-6 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                        <span className="font-['Kalnia'] font-bold text-[24px] text-[#000000] mb-4">2.</span>
                        <p className="font-['Kantumruy'] text-[15px] md:text-[16px] leading-relaxed text-[#393939]">
                    ...
                    {/* Column 3 */}
                    <div className="flex flex-col p-6 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                        <span className="font-['Kalnia'] font-bold text-[24px] text-[#000000] mb-4">3.</span>
                        <p className="font-['Kantumruy'] text-[15px] md:text-[16px] leading-relaxed text-[#393939]">
