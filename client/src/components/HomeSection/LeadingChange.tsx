...
export const LeadingChange: React.FC = () => {
  return (
    ...
    <section className="relative py-6 sm:py-12  lg:px-0">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="relative sm:min-h-[715px] min-h-[825px] lg:rounded-3xl overflow-hidden">
