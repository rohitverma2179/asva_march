    ...
    <section className="bg-linear-to-b from-[#cbf1fa] via-[#e0f7fc] to-white  py-6 sm:py-20 px-6 mt-10 w-full">
      <div className="max-w-full mx-auto text-center md:text-left">
        ...
        <div className="text-[16px] md:text-[16px] text-gray-600 leading-relaxed space-y-4 max-w-[92.5%] mx-auto">
          ...
          <p>
            Most water solutions are fragmented, different vendors for bottles,
            dispensers and devices. ASVA integrates everything with consistent
          ...
          <ul className="list-disc pl-5 space-y-2 text-[16px] text-left inline-block">
            <li>
              ...
              needs. The most trusted brand of packaged drinking water in India.
              Water is treated with an 11-step process to ensure purity and
              safety. You can choose from various pack sizes, from 200ml to 1
              litres.
            </li>
            <li>
              <span className="font-bold text-gray-800"> Subscriptions:</span>{" "}
              offices and institutions.
            </li>
            <li>
              <span className="font-bold text-gray-800">
                ASVA Ionizer Machines:
              </span>{" "}
              Convert normal water into alkaline water on demand ideal for
