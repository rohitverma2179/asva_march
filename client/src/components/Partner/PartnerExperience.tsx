  ...
  return (
    <section className="w-full bg-white pt-24 pb-20 px-8 lg:px-32 overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 md:px-12 lg:px-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-16 lg:mb-24 gap-12 lg:gap-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-16">
          ...
          <div className="aspect-[4/5] w-full rounded-bl-[120px] rounded-tr-[120px] overflow-hidden shadow-sm">
            <img
              src={amcPrime}
              alt="Expert Care 2"
              className="w-full h-full object-cover transition-transform duration-700 hover:scale-110"
          ...
          <div className="aspect-[4/5] w-full rounded-tl-[120px] rounded-br-[120px] overflow-hidden shadow-sm">
            <img
              src={amcHome}
              alt="Expert Care 3"
              className="w-full h-full object-cover transition-transform duration-700 hover:scale-110"
          ...
          <div className="aspect-[4/5] w-full rounded-t-[120px] rounded-bl-[120px] overflow-hidden shadow-sm">
            <img
              src={bottlePng}
              alt="Expert Care 4"
              className="w-full h-full object-cover transition-transform duration-700 hover:scale-110"
