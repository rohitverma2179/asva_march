...
const generateBlogPosts = (): BlogPost[] => {
  ...
  const ionizerContent: BlogContentBlock[] = [
    ...
    },
    {
      ...
      structuredItems: [
        {
          title: "1. Taste and mouthfeel",
          desc: "Alkaline water is often described as smoother and lighter on the palate compared to very acidic or very low TDS water. When water tastes good, people naturally sip more, supporting better hydration throughout the day.",
        },
        {
          title: "2. Lifestyle and wellness alignment",
          desc: "People experimenting with pH balanced diets, plant forward eating and overall wellness routines see ionized water as a way to align hydration with other conscious choices. While some sources promote strong health claims, responsible brands emphasise that alkaline water is one part of a broader healthy lifestyle rather than a medical treatment.",
        },
        {
          title: "3. Convenience and control",
          desc: "Ionizers provide on demand alkaline water directly from the tap, which is handy for homes, clinics and gyms where large volumes are consumed daily. Users also appreciate the ability to adjust pH levels for different purposes  milder alkaline water for everyday drinking, higher levels for occasional use such as certain dietary regimes, and neutral purified water for medication.",
        },
      ],
    },
    {
    ...
    },
    {
      type: "list",
      items: [
        "<b>Homes:</b> Families use alkaline water for drinking, cooking, tea and coffee, preferring the convenience of not carrying heavy or crates.",
    ...
    },
    {
      ...
      structuredItems: [
        {
          title: "1. Water source compatibility",
          desc: "Check whether your primary source is municipal tap water, borewell or pre treated RO water, as this affects the type and number of filters you need. Hard water regions may benefit from stronger scale control features and more frequent cleaning cycles.",
        },
        {
          title: "2. Plate material and design",
          desc: "Look for ionizers using quality titanium plates with platinum coating, as these materials support stable performance over time. Some manufacturers highlight plate shape (flat, mesh, slotted) to improve contact surface area and efficiency.",
        },
        {
          title: "3. pH range and flow rate",
          desc: "Check the advertised pH range and actual flow rate at different settings to ensure the machine can keep up with your household or business demand. For high traffic locations like gyms and clinics, consistent output at higher volumes is crucial.",
        },
        {
          title: "4. Certification, warranty and service network",
          desc: "Choose brands that clearly state testing standards, offer transparent warranties and maintain responsive service coverage in your city. Ionizers are long term investments, so filter availability and service turnaround time should heavily influence the decision.",
        },
      ],
    },
    {
  ...
  const phTdsOrpContent: BlogContentBlock[] = [
    ...
    },
    {
      ...
      structuredItems: [
        {
          title: "1. pH range",
          desc: "Look for a pH value within roughly 6.5–8.5 for regular drinking water, or slightly higher if it is clearly labelled as alkaline drinking water. Extremely high or low values should prompt deeper questions about suitability and intended use.",
        },
        {
          title: "2. TDS value and mineral profile",
          desc: "Check whether TDS is extremely low (which may taste flat) or very high (which may cause scaling or off tastes). Where possible, see if the label indicates key minerals such as calcium and magnesium that contribute to balanced flavour and mouthfeel.",
        },
        {
          title: "3. ORP claims",
          desc: "If a brand heavily advertises ORP numbers, treat them as one part of the picture, not the entire story, and ensure the supplier also talks about microbiological safety and compliance with relevant standards.",
        },
        {
          title: "4. Testing and certification",
          desc: "Reliable suppliers  whether bottled water plants or ionizer manufacturers  usually share information on quality checks, certifications and testing frequency to build trust.",
        },
      ],
    },
    {
  ...
  const packagedVsIonizerContent: BlogContentBlock[] = [
    ...
    {
      type: "paragraph",
      text: "Packaged alkaline water is purified, mineral balanced water with a higher pH that is filled into sealed bottles  at a central plant. The process usually involves multi stage filtration, pH adjustment through mineralisation or ionization, and rigorous quality testing before bottling and dispatch.",
    },
    {
      type: "list",
      items: [
        "Ready to drink bottles in convenient sizes such as 200 ml, 500 ml and 1 L for individual use, plus larger  for pantry supply.",
    ...
    },
    {
      type: "list",
      items: [
        "Continuous supply without storing crates .",
    ...
    {
      type: "paragraph",
      text: "Ionizers require one time installation and ongoing filter maintenance, but once set up, they deliver alkaline water directly from the tap at the press of a button. For everyday use in a fixed location, this reduces the effort of ordering, receiving and storing large volumes of bottles .",
    },
    {
      type: "h2",
  ...
  const sustainablePackagingContent: BlogContentBlock[] = [
    ...
    {
      type: "paragraph",
      text: "Sealed bottles  remain essential in many scenarios: travel, hospitality, hospitals, events and locations where tap infrastructure cannot guarantee quality. Packaged water ensures tamper evident hygiene, traceable batch numbers and consistent pH and TDS levels across millions of units.",
    },
    {
      type: "paragraph",
    ...
    },
    {
      ...
      items: [
        ...
        "<b>Deposit refund or take back schemes:</b> Implementing systems for large  and institutional clients to encourage returns.",
    ...
    },
    {
      type: "list",
      items: [
        "<b>Refillable subscription services</b> for offices and homes to minimize daily throughput.",
  ...
  const urbanFamiliesContent: BlogContentBlock[] = [
    ...
    },
    {
      ...
      items: [
        ...
        "<b>Subscription services:</b> These deliver or bottles on fixed schedules so families do not have to remember to reorder.",
      ],
    },
    {
      type: "paragraph",
  ...
  for (let i = 1; i <= 15; i++) {
    ...
    if (i === 1) {
      ...
      title =
        "<b>How Alkaline Water Ionizers Work</b> | Alkaline Machine Guide for Homes & Clinics";
      metaTitle =
        "How Alkaline Water Ionizers Work | Alkaline Machine Guide for Homes & Clinics";
      metaDesc =
        "Learn how alkaline water ionizer machines work, what pH and ORP mean, and how to choose the right alkaline water system for your home, clinic, gym or office.";
    ...
    if (i === 2) {
      ...
      title =
        "<b>pH vs TDS vs ORP in Drinking Water</b> | Simple Guide for Better Hydration";
      metaTitle =
        "pH vs TDS vs ORP in Drinking Water | Simple Guide for Better Hydration";
      metaDesc =
        "Confused by pH, TDS and ORP on water reports and purifier ads? Learn what each term means, ideal ranges, and how to choose safer, better tasting drinking water for your home or business.";
    ...
    if (i === 3) {
      ...
      title =
        "<b>Packaged Alkaline Water vs Ionizer Machines</b> | Best Hydration Option for Home & Business";
      metaTitle =
        "Packaged Alkaline Water vs Ionizer Machines | Best Hydration Option for Home & Business";
      metaDesc =
        "Should you buy packaged alkaline water or invest in an ionizer machine? Compare convenience, cost, sustainability and ideal use cases to pick the right hydration solution.";
    ...
    if (i === 4) {
      ...
      title =
        "<b>Alkaline Water for Offices & Co Working Spaces</b> | Hydration for Teams & Guests";
      metaTitle =
        "Alkaline Water for Offices & Co Working Spaces | Hydration for Teams & Guests";
      metaDesc =
        "Discover how alkaline water bottles and ionizer machines improve office hydration, employee wellbeing and client hospitality while reducing plastic waste in co working spaces.";
    ...
    if (i === 5) {
      ...
      title =
        "<b>Alkaline Water for Gyms, Yoga Studios & Wellness Centres</b> | Hydration for Active Lifestyles";
      metaTitle =
        "Alkaline Water for Gyms, Yoga Studios & Wellness Centres | Hydration for Active Lifestyles";
      metaDesc =
        "See how alkaline water stations and bottles support hydration for gyms, yoga studios and wellness centres, enhancing member experience and strengthening your wellness brand.";
    ...
    if (i === 6) {
      ...
      title =
        "<b>Responsible Alkaline Water Packaging & Recycling</b> | Sustainable Hydration";
      metaTitle =
        "Responsible Alkaline Water Packaging & Recycling | Sustainable Hydration";
      metaDesc =
        "Learn how responsible packaging, EPR compliance and refill models can reduce plastic impact in the alkaline water industry while keeping convenience and hygiene intact.";
    ...
    if (i === 7) {
      ...
      title =
        "<b>Alkaline Water Safety for Kids, Adults & Seniors</b> | How Much Is Okay?";
      metaTitle =
        "Alkaline Water Safety for Kids, Adults & Seniors | How Much Is Okay?";
      metaDesc =
        "Wondering if alkaline water is safe for children, adults and seniors? Learn recommended pH ranges, how much to drink and when to be cautious.";
    ...
    if (i === 8) {
      ...
      title =
        "<b>Why Urban Families Choose Alkaline Water</b> | Modern Hydration Trend in India";
      metaTitle =
        "Why Urban Families Choose Alkaline Water | Modern Hydration Trend in India";
      metaDesc =
        "Discover why health conscious families in Indian cities are moving to alkaline water  covering taste, lifestyle, convenience and how to adopt it safely at home.";
    ...
    if (i === 9) {
      ...
      title =
        "<b>Alkaline Water vs Regular Water</b> | Which Is Better for Daily Drinking?";
      metaTitle =
        "Alkaline Water vs Regular Water | Which Is Better for Daily Drinking?";
      metaDesc =
        "Confused between alkaline water and regular packaged drinking water? Understand the difference in pH, minerals, taste, cost and lifestyle so you can choose what suits you best.";
    ...
    if (i === 10) {
      ...
      title =
        "<b>Alkaline Water for Acidity & Heartburn</b> | What You Should Know";
      metaTitle =
        "Alkaline Water for Acidity & Heartburn | What You Should Know";
      metaDesc =
        "Heard that alkaline water can reduce acidity or heartburn? Learn how it interacts with stomach acid, where it may help, and why it is not a replacement for medical treatment.";
    ...
    if (i === 11) {
      ...
      title =
        "<b>Alkaline Water Machine Maintenance Guide</b> | Keep Your Ionizer Healthy";
      metaTitle =
        "Alkaline Water Machine Maintenance Guide | Keep Your Ionizer Healthy";
      metaDesc =
        "Keep your alkaline water ionizer running smoothly with this simple home maintenance guide. Learn when to clean, how often to change filters and what signs to watch for.";
    ...
    if (i === 12) {
      ...
      title =
        "<b>Alkaline Water Myths vs Facts</b> | Honest Guide for Everyday Drinkers";
      metaTitle =
        "Alkaline Water Myths vs Facts | Honest Guide for Everyday Drinkers";
      metaDesc =
        "Is alkaline water a miracle cure or just marketing hype? Get a balanced view of common myths and real facts so you can make informed hydration choices.";
    ...
    if (i === 13) {
      ...
      title =
        "<b>Alkaline Water for Athletes</b> | Hydration for Sports, Gyms & Runners";
      metaTitle =
        "Alkaline Water for Athletes | Hydration for Sports, Gyms & Runners";
      metaDesc =
        "Find out how alkaline water fits into sports hydration. Learn when it may help, how it compares to regular water and sports drinks, and how athletes can use it safely.";
    ...
    if (i === 14) {
      ...
      title =
        "<b>Cooking with Alkaline Water |</b> Indian Dals, Rice, Tea & More";
      metaTitle = "Cooking with Alkaline Water | Indian Dals, Rice, Tea & More";
      metaDesc =
        "Can alkaline water make a difference to Indian dishes like dal, rice, chai and curries? Explore how pH and minerals affect taste, texture and cooking time in your kitchen.";
    ...
    if (i === 15) {
      ...
      title =
        "<b>Daily Routine with Alkaline Water</b> | Easy Habits for Better Hydration";
      metaTitle =
        "Daily Routine with Alkaline Water | Easy Habits for Better Hydration";
      metaDesc =
        "Want to use alkaline water effectively without overthinking? Learn how to fit it into a realistic daily routine  from morning to night  at home, work and on the go.";
